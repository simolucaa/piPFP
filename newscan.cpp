...
static void save_update_word(Args& arg, string& w, unordered_map<uint64_t,word_stats>&  freq, FILE *tmp_parse_file, FILE *last, FILE *sa, uint64_t &pos);
...
uint64_t process_file(Args& arg, unordered_map<uint64_t,word_stats>& wordFreq)
{
...
// void remapParse(Args &arg, unordered_map<uint64_t,word_stats> &wfreq)
// {
